...
export default function DeathToll() {
  return (
    <section className="flex flex-col lg:flex-row justify-between items-center my-4 p-4 bg-blue-50">
      {/* Text section */}
      ...
      <div className="w-full lg:w-7/12 flex flex-col justify-start items-center lg:items-end relative lg:-top-12">
        ...
        {/* Chart container */}
        <div className="bg-gray-50 px-4 md:px-8 pt-10 md:pt-20 rounded-3xl shadow-lg w-full lg:w-full">
          <Chart />
        </div>
      </div>
    </section>
